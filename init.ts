...
import { showActionToast, showErrorToast, showToast } from "../ui/toast.js";
...
function showErrorBanner(errorRoot: HTMLElement, message: string): void {
  // Keep the legacy call sites, but route every front-end error through the
  // shared dismissible toast. Never render errors into the chat/error panel.
