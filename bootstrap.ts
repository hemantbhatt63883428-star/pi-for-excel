...
import { installGlobalErrorToastHandlers, showErrorToast } from "../ui/toast.js";
...
function showFatalError(errorRoot: HTMLElement, message: string): void {
  // Fatal startup errors use the same front-end toast path. Keep the legacy
  // error root empty so no giant error panel appears in the taskpane.
